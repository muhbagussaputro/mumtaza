...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="px-4 py-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-blue-100 text-sm">Lengkapi data siswa baru</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Form -->
    <div class="px-4 py-6">
        <form action="{{ route('admin.siswas.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="no_hp_ortu" name="no_hp_ortu" value="{{ old('no_hp_ortu') }}" 
